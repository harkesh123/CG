...
const UppyStyleWrapperContent = styled.div`
  display: flex;
  ...
  .UppyDashboard--wide .UppyDashboard-close {
    color: #525252;
    top: 16px;
    right: ${props => (props['data-rtl'] === 'rtl' ? '16px' : 'auto')};
    left: ${props => (props['data-rtl'] === 'rtl' ? 'auto' : '16px')};
  }
  ...
  .UppyDashboard--wide .UppyDashboardItem-sourceIcon {
    top: 8px;
    left: ${props => (props['data-rtl'] === 'rtl' ? 'auto' : '8px')};
    right: ${props => (props['data-rtl'] === 'rtl' ? '8px' : 'auto')};
    width: 15px;
    height: 15px;
  }
  ...
  .UppyDashboard-close {
    ...
    position: fixed;
    top: 12px;
    right: ${props => (props['data-rtl'] === 'rtl' ? '12px' : 'auto')};
    left: ${props => (props['data-rtl'] === 'rtl' ? 'auto' : '12px')};
    cursor: pointer;
    color: #929292;
    z-index: 1004;
    transition: all 0.2s;
  ...
  .UppyDashboardContent-back {
    ...
    position: absolute;
    top: 0;
    right: ${props => (props['data-rtl'] === 'rtl' ? '15px' : 'auto')};
    left: ${props => (props['data-rtl'] === 'rtl' ? 'auto' : '15px')};
    font-size: 14px;
    line-height: 40px;
    font-weight: 500;
    cursor: pointer;
  ...
  .UppyDashboardContent-back .UppyIcon {
    position: relative;
    margin-right: ${props => (props['data-rtl'] === 'rtl' ? '3px' : 'auto')};
    margin-left: ${props => (props['data-rtl'] === 'rtl' ? 'auto' : '3px')};
  }
  ...
  .UppyDashboard-bgIcon {
    ...
    position: absolute;
    top: 50%;
    left: ${props => (props['data-rtl'] === 'rtl' ? 'auto' : '50%')};
    right: ${props => (props['data-rtl'] === 'rtl' ? '50%' : 'auto')};
  ...
  .UppyDashboardItem-sourceIcon {
    ...
    position: absolute;
    top: 4px;
    left: ${props => (props['data-rtl'] === 'rtl' ? 'auto' : '4px')};
    right: ${props => (props['data-rtl'] === 'rtl' ? '4px' : 'auto')};
    width: 10px;
    height: 10px;
    z-index: 1003;
  }
  ...
  .UppyDashboardItem-action {
    position: absolute;
    top: 8px;
    right: ${props => (props['data-rtl'] === 'rtl' ? '5px' : 'auto')};
    left: ${props => (props['data-rtl'] === 'rtl' ? 'auto' : '5px')};
    z-index: 1003;
  }
  ...
  .UppyDashboardItem.is-complete .UppyDashboardItem-progress {
    ...
    transform: none;
    top: -7px;
    right: ${props => (props['data-rtl'] === 'rtl' ? 'auto' : '-7px')};
    left: ${props => (props['data-rtl'] === 'rtl' ? '-7px' : 'auto')};
    width: auto;
    display: block;
  }
  ...
  .UppyDashboardFileCard-input {
    ...
    font-size: 12px;
    line-height: 1.8;
    padding-left: ${props => (props['data-rtl'] === 'rtl' ? 'auto' : '5px')};
    padding-right: ${props => (props['data-rtl'] === 'rtl' ? '5px' : 'auto')};
    margin: auto;
  }
  ...
  .UppyProvider-breadcrumbs {
    ...
    padding: 0;
    margin: 0;
    margin-left: ${props => (props['data-rtl'] === 'rtl' ? 'auto' : '16px')};
    margin-right: ${props => (props['data-rtl'] === 'rtl' ? '16px' : 'auto')};
  }
  ...
  .Browser-breadcrumbs span {
    font-size: 16px;
    margin-left: ${props => (props['data-rtl'] === 'rtl' ? 'auto' : '32px')};
    margin-right: ${props => (props['data-rtl'] === 'rtl' ? '32px' : 'auto')};
  }
  ...
  .UppyStatusBar-content {
    ...
    position: relative;
    z-index: 1003;
    padding-left: ${props => (props['data-rtl'] === 'rtl' ? 'auto' : '15px')};
    padding-right: ${props => (props['data-rtl'] === 'rtl' ? '15px' : 'auto')};
    white-space: nowrap;
    text-overflow: ellipsis;
    overflow: hidden;
  }
  ...
  .UppyWebcam-buttonContainer {
    position: absolute;
    bottom: 30px;
    right: ${props => (props['data-rtl'] === 'rtl' ? '30px' : 'auto')};
    left: ${props => (props['data-rtl'] === 'rtl' ? 'auto' : '30px')};
  }
...
const UppyStyleWrapper = WithDirection(UppyStyleWrapperContent);
